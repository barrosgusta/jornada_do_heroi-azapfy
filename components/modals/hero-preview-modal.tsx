        ...
        >
            ...
            >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="relative justify-self-center max-w-xs border-2 border-zinc-500 dark:border-zinc-900 rounded-xl overflow-hidden shadow-xl aspect-[3/4] w-[80%]">
                        <NextImage
                            fill
                            alt="Hero Image"
                            src={hero.images.lg || ""}
                    ...
                    <ScrollArea className="justify-self-center row-span-2 p-0 border rounded-lg shadow-md max-h-44 md:max-h-96">
