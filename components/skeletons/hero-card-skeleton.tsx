        ...
        > 
            <div className="absolute text-center w-full bottom-0 p-4 bg-white/80 dark:bg-black/80 backdrop-blur-2xl rounded-lg overflow-hidden">
                <div className="space-y-2 flex flex-col items-center">
                    <div className="bg-zinc-400 dark:bg-zinc-800 rounded-md animate-pulse w-full p-2" />
                    <div className="bg-zinc-400 dark:bg-zinc-800 rounded-md animate-pulse w-1/2 p-2" />
                </div>
            </div>
        </div>
    )
